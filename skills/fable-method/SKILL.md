...
Git-ignored on purpose: per-machine, and it keeps AI-method artifacts out of a production repo — except the `.fable/` line in `.gitignore` itself, which is committed like any other ignore rule.
